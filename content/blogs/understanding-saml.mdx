...
description: SAML is an acronym used to describe the Security Assertion Markup Language (SAML). Its primary role in online security is that it enables you to access multiple web applications using one set of login credentials. It works by passing authentication information in a particular format between two parties, usually an identity provider (IdP) and a web application as a service provider (SP).
language: en
...
<MdxImage
  ...
  altComponent={<>How it works (ref: <a href="https://learn.microsoft.com/en-us/azure/active-directory/fundamentals/auth-saml" target="_blank">SAML authentication with Azure Active Directory</a>)</>}
/>
